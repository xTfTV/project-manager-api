...
public interface IProjectService
{
    ...
    Task<bool> CompleteProjectAsync(int projectId, int createdByUserId);

    Task<ProjectListResponse> GetProjectsByFilterAsync(ProjectQueryRequest request, int createdByUserId);
}
